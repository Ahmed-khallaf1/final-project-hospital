    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                $modules = ['UserType','users','appointments','reservation'];
            }elseif(($_SESSION ['user']['type_id'])==3){
                $modules = ['appointments','reservation'];
                ...
                ?>
                    ...
                    <div class="collapse" id="collapseLayouts<?php echo $key;?>" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="<?php echo url($value);?>/index.php">Display <?php echo $value;?>
                            </a>
                        </nav>
                    </div>
